...
export default function ReservationList() {
  const [reservations, setReservations] = useState<null | ReservationsResponse>(null);
  ...
  return (
    ...
    >
      ...
      {isLoading ? 
          (<CircularProgress/>) : (
        reservations != null && reservations.length === 0 ? (<Typography variant="h6">No reservations are made...</Typography>) : "hello!";
          )
      }
    </Box>
  );
